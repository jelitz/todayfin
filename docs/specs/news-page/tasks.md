...
- ✅ T12. (2026-08-08 사용자 피드백) 피드 20건/페이지 페이지네이션 + 시각 표기 "MM.DD HH:MM" 상시 날짜(formatNewsRelativeTime 폐기) + 테스트·문서 개정

의존: T2→(T5·T6), T3→T6, T4→(T6·T7), T5→T6, T6→T7, 전부→T9→T10→T11, T11→T12
